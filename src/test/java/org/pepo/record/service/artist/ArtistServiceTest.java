...
class ArtistServiceTest {
    ...
    void findAll() {
        ...
        when(artistEntityDtoMapper.entityToDto(ArgumentMatchers.any(Artist.class))).thenReturn(ArtistDto.builder().build());
    ...
    void save() {
        ...
        Artist artist = artistService.save(new Artist());
